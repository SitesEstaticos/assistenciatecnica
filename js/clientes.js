        ...
        row.innerHTML = `
            ...
            <td>
                <button class="btn btn-small btn-secondary"
                    onclick="viewClientEquipments('${cliente.id}')">
                    Ver
                </button>
            </td>
            ...
            <td>
                <button class="btn btn-small btn-primary"
                    onclick="openEditClientModal('${cliente.id}')">
                    Editar
                </button>
...
async function viewClientEquipments(clienteId) {
    ...
    try {
        ...
        document.getElementById('detailName').textContent = cliente.nome;
        document.getElementById('detailEmail').textContent = cliente.email || '';
        document.getElementById('detailPhone').textContent = cliente.telefone;

        document.getElementById('detailCpf').textContent = cliente.cpf || 'N/A';
        document.getElementById('detailAddress').textContent = cliente.endereco || 'N/A';
